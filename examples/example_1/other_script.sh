...
first_function() {
  # This function is just a placeholder to ensure the script is not executed
  # directly. It can be replaced with your own logic.
  kbx_log info "First function executed successfully."
}
